...
const TemplateQuietLuxury = ({ profile }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center relative" 
      ...
      {/* HEADER */}
      <div className="w-full px-6 flex justify-between items-center z-50 mb-6 mt-6">
      ...
      <div className="w-full max-w-[85%] space-y-3 relative z-10">
        <button onClick={() => {
          ...
          }} className={`w-full rounded-xl ${hasPortfolio ? 'py-4' : 'py-5'} text-[11px] font-black tracking-[0.15em] text-black flex items-center justify-center gap-3 transition-all active:scale-95 shadow-lg`}
        ...
        {data.location && (
          <a href={data.location} target="_blank" rel="noopener noreferrer" className="block w-full">
            <button className={`w-full bg-white/5 border border-white/10 text-white/90 rounded-xl ${hasPortfolio ? 'py-4' : 'py-5'} text-[10px] tracking-[0.15em] flex items-center justify-center gap-3 active:bg-white/10 transition-all backdrop-blur-sm uppercase`}>
        ...
        {websiteHref && (
          <a href={websiteHref} target="_blank" rel="noopener noreferrer" className="block w-full">
            <button className="w-full bg-white/5 border border-white/10 text-white/90 rounded-xl py-4 text-[10px] tracking-[0.15em] flex items-center justify-center gap-3 active:bg-white/10 transition-all backdrop-blur-sm uppercase font-bold">
